...
# Repository project
set :repository, 'git@bitbucket.org:luizpicolo/andemenos.com.git'

# Server Production
task :production do
  set :rails_env, 'production'
  set :user, 'andemenos'
  set :domain, '45.55.199.209'
  set :deploy_to, '/home/andemenos/public_html/railsapp'
  set :branch, 'master'
end
...
task :staging do
  ...
  set :user, 'staging'
  set :domain, '45.55.249.188 '
  set :deploy_to, '/home/staging/public_html/railsapp'
  set :branch, 'master'
end
